...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $type_compte = cleanInput($_POST['type_compte'] ?? 'client');
    ...
    if (empty($nom) || empty($email) || empty($telephone) || empty($password)) {
        ...
        if ($stmt->fetch()) {
            ...
            try {
                $stmt->execute([$nom, $email, $telephone, $hashedPassword, $type_compte]);
                    ...
                    <ul class="auth-benefits">
                        <li>
                            ...
                            <div>
                                ...
                                <p>Réservez vos appartements meublés en quelques clics</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                ...
                                <p>Suivez toutes vos réservations passées et futures</p>
                            </div>
                        </li>
                        <li>
                            <i class="fas fa-bell"></i>
                            <div>
                                <h4>Alertes disponibilités</h4>
                                <p>Soyez notifié des nouvelles disponibilités</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                ...
                                <p>Accédez à tous nos services immobiliers</p>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="index.html#appartements">Appartements</a></li>
                ...
                <div class="footer-section">
                    <h4>Contact</h4>
                    <ul>
                        <li><i class="fas fa-map-marker-alt"></i> 123 Avenue de l'Immobilier, Paris</li>
                        <li><i class="fas fa-phone"></i> +33 1 23 45 67 89</li>
                        <li><i class="fas fa-envelope"></i> contact@logilocimmo.fr</li>
                    </ul>
                </div>
            </div>
